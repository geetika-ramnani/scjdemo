              ...
              {step === 4 && (
                <>
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
                      <label className={`flex flex-col gap-3 p-6 rounded-2xl border-2 cursor-pointer transition-all duration-300 shadow-lg hover:scale-105 hover:shadow-yellow-400/20 bg-gradient-to-br from-yellow-400/5 to-orange-400/5 ${form.rights === 'exclusive' ? 'border-yellow-400 ring-2 ring-yellow-400/40 scale-105 bg-gradient-to-br from-yellow-400/20 to-orange-400/10' : 'border-white/20 hover:border-yellow-400/60'}`}
                        ...
                        <div className="flex items-center gap-4 mb-2">
                          ...
                          <span className="font-extrabold text-lg bg-gradient-to-r from-yellow-400 via-orange-400 to-red-400 bg-clip-text text-transparent drop-shadow">
                            Exclusive Rights
                          </span>
                        </div>
                      ...
                      <label className={`flex flex-col gap-3 p-6 rounded-2xl border-2 cursor-pointer transition-all duration-300 shadow-lg hover:scale-105 hover:shadow-yellow-400/20 bg-gradient-to-br from-yellow-400/5 to-orange-400/5 ${form.rights === 'nonexclusive' ? 'border-yellow-400 ring-2 ring-yellow-400/40 scale-105 bg-gradient-to-br from-yellow-400/20 to-orange-400/10' : 'border-white/20 hover:border-yellow-400/60'}`}
                        ...
                        <div className="flex items-center gap-4 mb-2">
                          ...
                          <span className="font-extrabold text-lg bg-gradient-to-r from-green-400 via-yellow-400 to-orange-400 bg-clip-text text-transparent drop-shadow">
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
                      <label className={`flex flex-col gap-3 p-6 rounded-2xl border-2 cursor-pointer transition-all duration-300 shadow-lg hover:scale-105 hover:shadow-yellow-400/20 bg-gradient-to-br from-yellow-400/5 to-orange-400/5 ${form.payment === 'revenue' ? 'border-yellow-400 ring-2 ring-yellow-400/40 scale-105 bg-gradient-to-br from-yellow-400/20 to-orange-400/10' : 'border-white/20 hover:border-yellow-400/60'}`}
                        ...
                        <div className="flex items-center gap-4 mb-2">
                          ...
                          <span className="font-extrabold text-lg bg-gradient-to-r from-yellow-400 via-orange-400 to-red-400 bg-clip-text text-transparent drop-shadow">Revenue Share</span>
                        </div>
                      ...
                      <label className={`flex flex-col gap-3 p-6 rounded-2xl border-2 cursor-pointer transition-all duration-300 shadow-lg hover:scale-105 hover:shadow-yellow-400/20 bg-gradient-to-br from-yellow-400/5 to-orange-400/5 ${form.payment === 'mg' ? 'border-yellow-400 ring-2 ring-yellow-400/40 scale-105 bg-gradient-to-br from-yellow-400/20 to-orange-400/10' : 'border-white/20 hover:border-yellow-400/60'}`}
                        ...
                        <div className="flex items-center gap-4 mb-2">
                          ...
                          <span className="font-extrabold text-lg bg-gradient-to-r from-yellow-400 via-orange-400 to-red-400 bg-clip-text text-transparent drop-shadow">Minimum Guarantee</span>
                        </div>
                      ...
                      <label className={`flex flex-col gap-3 p-6 rounded-2xl border-2 cursor-pointer transition-all duration-300 shadow-lg hover:scale-105 hover:shadow-yellow-400/20 bg-gradient-to-br from-yellow-400/5 to-orange-400/5 ${form.payment === 'flat' ? 'border-yellow-400 ring-2 ring-yellow-400/40 scale-105 bg-gradient-to-br from-yellow-400/20 to-orange-400/10' : 'border-white/20 hover:border-yellow-400/60'}`}
                        ...
                        <div className="flex items-center gap-4 mb-2">
                          ...
                          <span className="font-extrabold text-lg bg-gradient-to-r from-yellow-400 via-orange-400 to-red-400 bg-clip-text text-transparent drop-shadow">Flat Fee</span>
                        </div>
                      ...
                      <label className={`flex flex-col gap-3 p-6 rounded-2xl border-2 cursor-pointer transition-all duration-300 shadow-lg hover:scale-105 hover:shadow-yellow-400/20 bg-gradient-to-br from-yellow-400/5 to-orange-400/5 ${form.payment === 'hybrid' ? 'border-yellow-400 ring-2 ring-yellow-400/40 scale-105 bg-gradient-to-br from-yellow-400/20 to-orange-400/10' : 'border-white/20 hover:border-yellow-400/60'}`}
                        ...
                        <div className="flex items-center gap-4 mb-2">
                          ...
                          <span className="font-extrabold text-lg bg-gradient-to-r from-yellow-400 via-orange-400 to-red-400 bg-clip-text text-transparent drop-shadow">Hybrid Model</span>
                        </div>
                  ...
                  <div className="mb-10 flex flex-col gap-8">
                    ...
                    <div className="grid grid-cols-2 md:grid-cols-3 gap-4">
                      <label className={`flex items-center gap-8 p-4 rounded-lg border-2 cursor-pointer transition-all duration-300 hover:scale-105 ${
                        ...
                        />
                        <span className="ml-2 font-extrabold text-base bg-gradient-to-r from-yellow-400 via-orange-400 to-red-400 bg-clip-text text-transparent drop-shadow">Premium OTT</span>
                      </label>
                      <label className={`flex items-center gap-8 p-4 rounded-lg border-2 cursor-pointer transition-all duration-300 hover:scale-105 ${
                        ...
                        <input 
                          ...
                          className="w-5 h-5 accent-yellow-400" 
                        />
                        <span className="ml-2 font-extrabold text-base bg-gradient-to-r from-yellow-400 via-orange-400 to-red-400 bg-clip-text text-transparent drop-shadow">Regional OTT</span>
                      </label>
                      <label className={`flex items-center gap-8 p-4 rounded-lg border-2 cursor-pointer transition-all duration-300 hover:scale-105 ${
                        ...
                        <input 
                          ...
                          className="w-5 h-5 accent-yellow-400" 
                        />
                        <span className="ml-2 font-extrabold text-base bg-gradient-to-r from-yellow-400 via-orange-400 to-red-400 bg-clip-text text-transparent drop-shadow">Satellite TV</span>
                      </label>
                      <label className={`flex items-center gap-8 p-4 rounded-lg border-2 cursor-pointer transition-all duration-300 hover:scale-105 ${
                        ...
                        <input 
                          ...
                          onChange={handleChange} 
                          className="w-5 h-5 accent-yellow-400" />
                        <span className="ml-2 font-extrabold text-base bg-gradient-to-r from-yellow-400 via-orange-400 to-red-400 bg-clip-text text-transparent drop-shadow">Theatrical</span>
                      </label>
                      <label className={`flex items-center gap-8 p-4 rounded-lg border-2 cursor-pointer transition-all duration-300 hover:scale-105 ${
                        ...
                        <input 
                          ...
                          onChange={handleChange} 
                          className="w-5 h-5 accent-yellow-400" />
                        <span className="ml-2 font-extrabold text-base bg-gradient-to-r from-yellow-400 via-orange-400 to-red-400 bg-clip-text text-transparent drop-shadow">Inflight</span>
                      </label>
                      <label className={`flex items-center gap-8 p-4 rounded-lg border-2 cursor-pointer transition-all duration-300 hover:scale-105 ${
                        form.platforms.all 
                          ? 'border-yellow-400 bg-gradient-to-r from-yellow-400/10 to-orange-400/10 shadow-yellow-400/20' 
                        ...
                        <input 
                          ...
                          className="w-5 h-5 accent-yellow-400" 
                        />
                        <span className="ml-2 font-extrabold text-base bg-gradient-to-r from-yellow-400 via-orange-400 to-red-400 bg-clip-text text-transparent drop-shadow">All Platforms</span>
                      </label>
                    </div>
                  </div>
                  ...
                  <textarea 
                    ...
                    onChange={handleChange} 
                    className="w-full text-base rounded-lg border border-white/10 bg-[#23232b] text-white px-6 py-4 focus:outline-none focus:ring-2 focus:ring-yellow-400/60 placeholder-gray-400 transition-all duration-300 min-h-[120px] resize-none mb-10" 
                    placeholder="Any additional information about your content, distribution preferences, or special requirements..." 
                  />
                  {/* Terms and Conditions Checkbox */}
                  <label htmlFor="termsAccepted" className="flex items-center gap-3 cursor-pointer select-none mb-10">
                    <input
                      type="checkbox"
                      name="termsAccepted"
                      ...
                      onChange={handleChange}
                      required
                      className="w-6 h-6 accent-yellow-400 rounded-xl border-2 border-yellow-400/40 ring-2 ring-yellow-400/60 bg-[#181b29] shadow focus:ring-4 focus:ring-yellow-400/80 transition-all duration-200 mr-4"
                      id="termsAccepted"
                    />
                    <span className="text-white text-lg font-semibold ml-1">
                      I agree to the <a href="#" className="text-yellow-400 underline hover:text-orange-400">Terms and Conditions</a> <span className="text-yellow-400">*</span>
                    </span>
                  </label>
                  {submitted && !form.termsAccepted && (
                    <div className="text-red-400 text-sm mt-2 mb-4">You must agree to the Terms and Conditions to submit the form.</div>
                  )}
                </>
              )}
            </div>
